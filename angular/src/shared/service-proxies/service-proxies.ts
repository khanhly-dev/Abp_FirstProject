...
@Injectable()
export class CardInfoServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    createCard(body: CreateCardDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/CardInfo/CreateCard";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateCard(<any>response_);
                } catch (e) {
    ...
    protected processCreateCard(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    deleteCard(cardId: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/CardInfo/DeleteCard?";
        if (cardId === null)
     ...
     * @return Success
     */
    getAllCardInfo(): Observable<GetCardDto[]> {
        let url_ = this.baseUrl + "/api/services/app/CardInfo/GetAllCardInfo";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllCardInfo(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllCardInfo(<any>response_);
                } catch (e) {
                    return <Observable<GetCardDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetCardDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllCardInfo(response: HttpResponseBase): Observable<GetCardDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(GetCardDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<GetCardDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    updateCard(body: UpdateCardDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/CardInfo/UpdateCard";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateCard(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateCard(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateCard(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class CityServiceProxy {
     ...
     * @return Success
     */
    getAllCity(): Observable<GetCityDto[]> {
        let url_ = this.baseUrl + "/api/services/app/City/GetAllCity";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetCityDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetCityDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllCity(response: HttpResponseBase): Observable<GetCityDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(GetCityDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<GetCityDto[]>(<any>null);
    }
}
...
export class DistrictServiceProxy {
     ...
     * @return Success
     */
    getDistrictByCityId(cityId: number | undefined): Observable<GetDistrictDto[]> {
        let url_ = this.baseUrl + "/api/services/app/District/GetDistrictByCityId?";
        if (cityId === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetDistrictByCityId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetDistrictByCityId(<any>response_);
                } catch (e) {
                    return <Observable<GetDistrictDto[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetDistrictByCityId(response: HttpResponseBase): Observable<GetDistrictDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class GetCardDto implements IGetCardDto {
    ...
    static fromJS(data: any): GetCardDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetCardDto();
        result.init(data);
        return result;
    }
...
export class GetCityDto implements IGetCityDto {
    id: number;
    name: string | undefined;

    constructor(data?: IGetCityDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetCityDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetCityDto();
        result.init(data);
        return result;
    }
